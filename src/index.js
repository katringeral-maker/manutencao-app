...
// --- FIREBASE CONFIG ---
// Se apagou as chaves antes, o sistema usa "demo" para não bloquear a tela.
// Para guardar dados reais, tem de colocar as suas chaves aqui novamente.
const firebaseConfig = { 
    apiKey: "demo", 
    projectId: "demo" 
    // Substitua pelo seu: apiKey: "AIzaSy...", projectId: "..."
};
      ...
      <div className="h-full flex flex-col md:flex-row bg-gray-50">
        ...
        <div className="flex-1 p-6 overflow-y-auto">
          ...
          <div className="bg-white p-4 rounded shadow-sm border mb-4">
             ...
             <textarea className="border rounded p-2 w-full text-sm" rows={2} placeholder="Equipa
